...
MODIFIED BY KCL on 6/13/20 for yeast data
...
for line in iIntrons:
    ...
    gene = line.split('\t')[3].split('_')[0]    # gene name
    ...
    for read in iBAM.fetch(chrom, int(pos5SS)-1, int(pos5SS)):
        ...
        if pos5SS-read.pos<=100 or read.aend-pos5SS<=100: 
            ...
            if pos5SS-read.pos>=3 and read.aend-pos5SS>=3:
                ...
                # if read is in the sense direction for the intron    ### REMOVE REQUIREMENT FOR PAIRED-END READS
