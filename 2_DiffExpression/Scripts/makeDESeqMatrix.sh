...
sortBed -i $wt1_pos_file | awk 'BEGIN {OFS="\t"} {print $1, $2, $3, ".", $4}' - | bedmap --echo --delim "\t" --sum ../0_Annotations/Genes/genes_polII.noOver.coding_pos.bed - > tmp.wt1.pos.bed
sortBed -i $wt1_neg_file | awk 'BEGIN {OFS="\t"} {print $1, $2, $3, ".", $4}' - | bedmap --echo --delim "\t" --sum ../0_Annotations/Genes/genes_polII.noOver.coding_neg.bed - > tmp.wt1.neg.bed
sortBed -i $wt2_pos_file | awk 'BEGIN {OFS="\t"} {print $1, $2, $3, ".", $4}' - | bedmap --echo --delim "\t" --sum ../0_Annotations/Genes/genes_polII.noOver.coding_pos.bed - > tmp.wt2.pos.bed
sortBed -i $wt2_neg_file | awk 'BEGIN {OFS="\t"} {print $1, $2, $3, ".", $4}' - | bedmap --echo --delim "\t" --sum ../0_Annotations/Genes/genes_polII.noOver.coding_neg.bed - > tmp.wt2.neg.bed
sortBed -i $wt3_pos_file | awk 'BEGIN {OFS="\t"} {print $1, $2, $3, ".", $4}' - | bedmap --echo --delim "\t" --sum ../0_Annotations/Genes/genes_polII.noOver.coding_pos.bed - > tmp.wt3.pos.bed
sortBed -i $wt3_neg_file | awk 'BEGIN {OFS="\t"} {print $1, $2, $3, ".", $4}' - | bedmap --echo --delim "\t" --sum ../0_Annotations/Genes/genes_polII.noOver.coding_neg.bed - > tmp.wt3.neg.bed
sortBed -i $wt4_pos_file | awk 'BEGIN {OFS="\t"} {print $1, $2, $3, ".", $4}' - | bedmap --echo --delim "\t" --sum ../0_Annotations/Genes/genes_polII.noOver.coding_pos.bed - > tmp.wt4.pos.bed
sortBed -i $wt4_neg_file | awk 'BEGIN {OFS="\t"} {print $1, $2, $3, ".", $4}' - | bedmap --echo --delim "\t" --sum ../0_Annotations/Genes/genes_polII.noOver.coding_neg.bed - > tmp.wt4.neg.bed
