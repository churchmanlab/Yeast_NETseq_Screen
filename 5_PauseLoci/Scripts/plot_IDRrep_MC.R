...
# Use: 
geneCov=2
./Scripts/plot_IDRrep_MC.R $geneCov
...
# Read data
data = read.table(paste0("IDR_reproducibility_cov", covT, ".txt"), stringsAsFactors = FALSE)
colnames(data) = c("Mut", "Rep1", "Rep2", "Comb",  "Perc", "IDR")
...
ggsave(file=paste0("IDRrep_cov", covT, ".pdf"), device="pdf", plot=p, width=9, height=4.5)
